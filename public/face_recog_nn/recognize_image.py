...
print(text)
cv2.waitKey(0)
# python recognize_image.py  --image "C:\Users\hp\
#Downloads\face-recognition-using-deep-learning-master\face-recognition-using-deep-learning-master\images\bhatia.png
